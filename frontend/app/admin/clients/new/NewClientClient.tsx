...
export default function NewClientClient() {
  ...
  const [form, setForm]     = useState({
    ...
    firstConsultationDate: '', concern: '', notes: '', status: 'active',
  });
  ...
  return (
    <>
      <div className={s.header}>
        <span className={s.title}>New Client</span>
        ...
        <form onSubmit={handleSubmit}>
          <div className={s.formGrid}>
            ...
            <div className={s.formGroup}>
              ...
              <input type="date" className={s.input} value={form.firstConsultationDate} onChange={e => update('firstConsultationDate', e.target.value)} required />
            </div>
            <div className={s.formGroup}>
          ...
          <div className={s.formActions}>
            ...
            <Link href="/admin/clients" className={`${s.btn} ${s.btnSecondary}`}>Cancel</Link>
          </div>
        </form>
      </div>
    </>
